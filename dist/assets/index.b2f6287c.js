...
const SplashScreen = registerPlugin("SplashScreen", {
  web: () => __vitePreload(() => import("./web.463e378b.js"), true ? [] : void 0).then((m) => new m.SplashScreenWeb())
});
var CameraSource;
...
registerPlugin("Camera", {
  web: () => __vitePreload(() => import("./web.6fb80bea.js"), true ? [] : void 0).then((m) => new m.CameraWeb())
});
var Directory;
(function(Directory2) {
...
const Filesystem = registerPlugin("Filesystem", {
  web: () => __vitePreload(() => import("./web.037760dc.js"), true ? [] : void 0).then((m) => new m.FilesystemWeb())
});
  ...
  class extends HTMLElement {
    ...
    <div>
      ...
      <main>
        ...
        <p>
          <button class="button" id="take-photo">Request File Permission</button>
        </p>
        <p>
...
export { CameraSource as C, Encoding as E, WebPlugin as W, CameraDirection as a, CapacitorException as b, buildRequestInit as c };
